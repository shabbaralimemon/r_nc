...
const UpdateListing = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    description: "",
    address: "",
    type: "rent", // Default type; ensure this matches your intended initial value
    bedrooms: 1,
    bathrooms: 1,
    regularPrice: 50,
    discountPrice: 0,
          ...
          <div className="flex gap-6 flex-wrap">
            <div className="flex gap-2">
              <input
                type="checkbox"
                id="flat"
                className="w-5 border-2 border-blue-500 rounded-md"
                checked={formData.type === "flat"}
                onChange={() => handleTypeChange("flat")}
              />
              <span className="font-bold text-blue-500">Flat</span>
            </div>
            <div className="flex gap-2">
              <input
                type="checkbox"
                id="hostel"
                className="w-5 border-2 border-green-500 rounded-md"
                checked={formData.type === "hostel"}
                onChange={() => handleTypeChange("hostel")}
              />
              <span className="font-bold text-green-500">Hostel</span>
            </div>
            <div className="flex gap-2">
              <input
                type="checkbox"
            ...
            <div className="flex gap-2">
              <input
                ...
                className="w-5"
                onChange={handleChange}
                checked={formData.safetyAndSecurity}
              />
            ...
            <div className="flex gap-2">
              <input
                ...
                className="w-5"
                onChange={handleChange}
                checked={formData.heatingAndCooling}
              />
